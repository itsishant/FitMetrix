...
>
  ...
  <div className="flex items-center space-x-4">
    <button
      className="cursor-pointer p-2 rounded-2xl hover:bg-red-500 hover:text-white text-base xl:text-lg font-Poppin"
      onClick={() => {
    ...
    {/* User Icon */}
    <div className="p-3 xl:p-4 xl:px-7 bg-gray-300 border-2 border-violet-600 text-2xl xl:text-3xl rounded-full font-Poppin shadow-lg">
      <User />
    </div>
  </div>
</motion.div>
